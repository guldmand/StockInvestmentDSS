...
\begin{definitionbox}[Principal $G$-bundle]
...
\begin{examplebox}[Frame bundles]
...
\begin{definitionbox}[Connection on a principal bundle]
...
\begin{propositionbox}[Transformation of local gauge potentials]
...
\begin{propositionbox}[Connections form an affine space]
...
\begin{definitionbox}[Pairing of cohomology and homology]
...
\begin{theorembox}[Universal coefficients for cohomology]
