# =============================================================================
# Robustness Test 3 — Non-tech universe (JPM,XOM,UNH,KO,WMT), 2018–2024
# =============================================================================
# Purpose: Verify that LayerNorm + q50 generalises beyond the primary tech universe.
#          The non-tech tickers (financials, energy, healthcare, consumer) have
#          different price ranges, volatility profiles, and correlation structures.
#          This tests that LayerNorm's scale-normalisation works across asset classes,
#          not just the high-price/high-volatility tech universe.
#
#          Pass criterion: seed=7 active trading (total_trades > 0, return != 0.0)
#          Fail criterion: seed=7 HOLD-collapse (total_trades == 0)
#          Bonus: compare return/Sharpe to demo_5 primary result — expected lower
#                 absolute return (non-tech 2023 underperformed tech), but similar
#                 policy stability.
#
...
# Dataset / universe
$env:STOCK_INVESTMENT_DSS_DAILY_DATASET_ID        = "robustness_nontech_2018_2024_layernorm_q50"
$env:STOCK_INVESTMENT_DSS_PIT_SPLIT_ID            = "robustness_nontech_2018_2024_layernorm_q50_pit"
$env:STOCK_INVESTMENT_DSS_UNIVERSE_ID             = "demo_5"
$env:STOCK_INVESTMENT_DSS_DAILY_DATA_UNIVERSE     = "demo_5"
$env:STOCK_INVESTMENT_DSS_FINRL_TICKERS           = "JPM,XOM,UNH,KO,WMT"

# PIT window — same as primary result
...
Write-Host ""
Write-Host "=== Robustness Test 3: LayerNorm + q50 | Non-tech (JPM,XOM,UNH,KO,WMT) | 2018-2024 ==="
Write-Host "Dataset:    $env:STOCK_INVESTMENT_DSS_DAILY_DATASET_ID"
Write-Host "Tickers:    $env:STOCK_INVESTMENT_DSS_FINRL_TICKERS"
Write-Host "Train:      2018-01-01 -> 2023-01-01"
