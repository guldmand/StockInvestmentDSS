# =============================================================================
# LayerNorm Lambda Ablation — Variant C: q50_minus_cvar_penalty, lambda=0.50
# =============================================================================
# Hypothesis: lambda=0.50 is the midpoint between pure q50 and lambda=0.75.
# Tests whether moderate CVaR penalisation still produces SELL-dominance.
# Expected: Active trading, intermediate SELL/BUY ratio vs A and D.
#
...
# Dataset / universe
$env:STOCK_INVESTMENT_DSS_DAILY_DATASET_ID    = "demo_5_layernorm_lambda_050"
$env:STOCK_INVESTMENT_DSS_PIT_SPLIT_ID        = "demo_5_layernorm_lambda_050_pit"
...
# Ablation variable C: q50_minus_cvar_penalty, lambda=0.50
$env:STOCK_INVESTMENT_DSS_IQN_BACKTEST_SCORE_MODE  = "q50_minus_cvar_penalty"
$env:STOCK_INVESTMENT_DSS_IQN_BACKTEST_RISK_LAMBDA = "0.50"
...
Write-Host ""
Write-Host "=== Ablation C: LayerNorm + q50_minus_cvar_penalty (lambda=0.50) ==="
