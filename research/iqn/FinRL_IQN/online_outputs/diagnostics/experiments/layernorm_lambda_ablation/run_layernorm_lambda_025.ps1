# =============================================================================
# LayerNorm Lambda Ablation — Variant B: q50_minus_cvar_penalty, lambda=0.25
# =============================================================================
# Hypothesis: lambda=0.75 over-penalises BUY. lambda=0.25 may preserve
# risk-awareness while allowing positive market exposure.
# Expected: Active trading with less SELL-dominance than lambda=0.75.
#
...
# Dataset / universe
$env:STOCK_INVESTMENT_DSS_DAILY_DATASET_ID    = "demo_5_layernorm_lambda_025"
$env:STOCK_INVESTMENT_DSS_PIT_SPLIT_ID        = "demo_5_layernorm_lambda_025_pit"
...
# Ablation variable B: q50_minus_cvar_penalty, lambda=0.25
$env:STOCK_INVESTMENT_DSS_IQN_BACKTEST_SCORE_MODE  = "q50_minus_cvar_penalty"
$env:STOCK_INVESTMENT_DSS_IQN_BACKTEST_RISK_LAMBDA = "0.25"
...
Write-Host ""
Write-Host "=== Ablation B: LayerNorm + q50_minus_cvar_penalty (lambda=0.25) ==="
