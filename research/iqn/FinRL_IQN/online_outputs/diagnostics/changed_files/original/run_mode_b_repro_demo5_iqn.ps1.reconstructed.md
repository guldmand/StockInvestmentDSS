# run_mode_b_repro_demo5_iqn.ps1 — RECONSTRUCTED, NOT VERIFIED

The original file was not available in VS Code Local History (only the post-change
version exists, saved at 2026-05-20 16:13:34).

This reconstruction removes the 3-line LayerNorm block added by Copilot. The rest
of the file is identical to the updated version.

## Before (original — reconstructed)
```powershell
# =============================================================================
...
## After (updated — verified current workspace)
```powershell
# =============================================================================
# Mode B: Reproducible thesis experiment
# =============================================================================
