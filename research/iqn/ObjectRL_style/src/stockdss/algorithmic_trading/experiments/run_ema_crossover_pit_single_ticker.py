...
from stockdss.algorithmic_trading.baselines.ema_crossover_pit_single_ticker import (
    run_ema_crossover,
)
...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description="Run PIT single-ticker algorithmic trading baseline: EMA crossover."
    )
...
def main() -> None:
    ...
    print_banner("StockDSS - Algorithmic Trading Baseline: EMA crossover")
    ...
    print()
    print_banner("EMA crossover finished")
