...
from stockdss.algorithmic_trading.baselines.bollinger_mean_reversion_pit_single_ticker import (
...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description="Run PIT single-ticker algorithmic trading baseline: Bollinger mean-reversion."
    )
...
def main() -> None:
    ...
    print_banner("StockDSS - Algorithmic Trading Baseline: Bollinger mean-reversion")
    ...
    outputs = run_bollinger_mean_reversion(
    ...
    print()
    print_banner("Bollinger mean-reversion finished")
