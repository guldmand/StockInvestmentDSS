...
from stockdss.algorithmic_trading.baselines.breakout_pit_single_ticker import (
    run_breakout,
)
...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description="Run PIT single-ticker algorithmic trading baseline: Breakout."
    )
...
def main() -> None:
    ...
    print_banner("StockDSS - Algorithmic Trading Baseline: Breakout")
    ...
    print()
    print_banner("Breakout finished")
