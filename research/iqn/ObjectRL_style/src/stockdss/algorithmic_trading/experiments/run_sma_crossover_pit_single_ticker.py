...
from stockdss.algorithmic_trading.baselines.sma_crossover_pit_single_ticker import (
    run_sma_crossover,
)
...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description="Run PIT single-ticker algorithmic trading baseline: SMA crossover."
    )
...
def main() -> None:
    ...
    print_banner("StockDSS - Algorithmic Trading Baseline: SMA crossover")
    ...
    print()
    print_banner("SMA crossover finished")
